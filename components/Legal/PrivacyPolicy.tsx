      ...
      <Modal visible={isVisible} onRequestClose={() => setIsVisible(false)}>
        <ScrollView style={styles.container}>
          ...
          <Text style={styles.text}>
            Girafs Venner er dataansvarlig for behandlingen af de personoplysninger, som vi har
          ...
          <Text style={styles.text}>
            - Tilvejebringe et kommunikationsværktøj til autistiske børn og institutionens
            medarbejdere.
          </Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.text}>
            ...
            databeskyttelsesforordningens artikel 6, stk. 1, litra f, med det formål at hjælpe
            autistiske børn med at kommunikere.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            Tilbagetrækning påvirker ikke lovligheden af tidligere behandling.
          </Text>
          ...
          <Text style={styles.text}>
            Du har ret til at indgive en klage til Datatilsynet, hvis du er utilfreds med vores
