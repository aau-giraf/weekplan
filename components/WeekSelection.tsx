...
import { TouchableOpacity, View, StyleSheet, Text, Modal, Button } from "react-native";
...
type WeekSelectionProps = {
    text: string;
    setWeekAndYear: (weekNumber: number, year: number) => void;
};
...
const WeekSelection: React.FC<WeekSelectionProps> = ({ text, setWeekAndYear }) => {
